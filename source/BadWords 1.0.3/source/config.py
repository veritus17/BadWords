...
# ==========================================
APP_NAME = "BadWords"
VERSION = "2.0.5" # Bumped version for new language support
...
TRANS = {
    "en": {
        ...
        "btn_quit": "Quit",
        "btn_apply": "Apply",
        "btn_generate": "Assemble", # Changed from Generate
        ...
        "status_generating": "Assembling timeline...", # Changed from Generating
        ...
        # Misc UI
        "msg_success": "Timeline assembled successfully!", # Changed from generated
    ...
    "pl": {
        ...
        "btn_quit": "Wyjdź",
        "btn_apply": "Zastosuj",
        "btn_generate": "Montuj", # Changed from Generuj
        ...
        "status_generating": "Montowanie timeline...", # Changed from Generowanie
        ...
        # Misc UI
        "msg_success": "Timeline zmontowany pomyślnie!", # Changed from wygenerowany
    ...
    "de": {
        ...
        "btn_quit": "Beenden",
        "btn_apply": "Anwenden",
        "btn_generate": "Montieren", # Changed from Generieren
        ...
        "status_generating": "Timeline wird montiert...", # Changed from Generiere
        ...
        "msg_success": "Timeline erfolgreich montiert!", # Changed from erstellt
    ...
    "es": {
        ...
        "btn_quit": "Salir",
        "btn_apply": "Aplicar",
        "btn_generate": "Ensamblar", # Changed from Generar
        ...
        "status_generating": "Ensamblando timeline...", # Changed from Generando
        ...
        "msg_success": "¡Timeline ensamblada con éxito!", # Changed from generada
    ...
    "fr": {
        ...
        "btn_quit": "Quitter",
        "btn_apply": "Appliquer",
        "btn_generate": "Assembler", # Changed from Générer
        ...
        "status_generating": "Assemblage de la timeline...", # Changed from Génération
        ...
        "msg_success": "Timeline assemblée avec succès !", # Changed from générée
    ...
    "it": {
        ...
        "btn_quit": "Esci",
        "btn_apply": "Applica",
        "btn_generate": "Assembla", # Changed from Genera
        ...
        "msg_success": "Timeline assemblata con successo!", # Changed from generata
    ...
    "pt": {
        ...
        "btn_quit": "Sair",
        "btn_apply": "Aplicar",
        "btn_generate": "Montar", # Changed from Gerar
        ...
        "msg_success": "Timeline montada com sucesso!", # Changed from gerada
    ...
    "uk": {
        ...
        "btn_generate": "Змонтувати", # Changed from Генерувати
        ...
        "status_generating": "Монтаж таймлайну...", # Changed from Генерація
        ...
        # Misc UI
        "msg_success": "Таймлайн успішно змонтовано!", # Changed from згенеровано
    ...
    "nl": {
        ...
        "btn_quit": "Afsluiten",
        "btn_apply": "Toepassen",
        "btn_generate": "Monteren", # Changed from Genereren
        ...
        "status_generating": "Timeline monteren...", # Changed from genereren
        ...
        "msg_success": "Timeline succesvol gemonteerd!", # Changed from gegenereerd
    ...
    "ru": {
        ...
        "chk_compound": "Исправить Compound Clip (если есть разрезы)",
        "hint_compound": "(Исправляет рассинхрон через вложение таймлайна)",
        "btn_analyze": "АНАЛИЗ",
        "btn_cancel": "Отмена",
        "btn_quit": "Выход",
        "btn_apply": "Применить",
        ...
        "chk_auto_del": "Авто-удаление красных клипов (может быть неточно)",
        ...
        # Status Messages
        "status_ready": "Готово.",
        "status_nesting": "Вложение таймлайна (Фикс)...",
        ...
        "status_loaded": "Загружено {count} слов. Авто-помечено: {bad}",
        "status_generating": "Сборка таймлайна...",
        "status_cleanup": "Очистка временных файлов...",
        "status_done": "Выполнено!",
        "status_comparing": "Сравнение сценария с аудио...",
        "status_reps": "Анализ дублей и пропусков (Контекст)...",
        ...
        "err_whisper": "Ошибка Whisper. Проверьте логи.",
        "err_nowords": "Слов не обнаружено.",
        "err_tl_create": "Ошибка создания таймлайна.",
        "err_nesting": "Не удалось найти текущий таймлайн.",
        "err_num": "Неверные числа в настройках.",
        "err_noscript": "Пожалуйста, сначала вставьте или импортируйте сценарий.",
        "ph_script": "Вставьте сценарий сюда или импортируйте кнопкой...",
        "disclaimer": "ВНИМАНИЕ: Транскрипция может быть неточной. Версия для разработки.",
        "file_types": "Текст / Word / PDF",
