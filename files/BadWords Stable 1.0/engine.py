...
class AudioEngine:
    ...
    def run_whisper(self, audio_path, model, lang, verbatim, device_mode, filler_words_list=None):
        ...
        env = os.environ.copy()
        # Clear Python-related env vars to avoid conflicts with pipx venv
        ...
        # CRITICAL FIX: REMOVED forced injection of /opt/rocm/lib.
        # Mixing system libraries with pipx venv causes Segfault -11 on Linux AMD.
        # Do NOT add LD_LIBRARY_PATH here manually.

        def build_cmd(force_cpu=False):
            # CHANGED: Enable FP16 (True) to reduce VRAM usage and prevent OOM crashes on AMD cards.
            # This is critical for stability on consumer Radeon cards (RX 6000/7000).
            use_fp16 = "True" 
        ...
        try:
            ...
            # Check for specific GPU failures
